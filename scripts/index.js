function arvuta() {
    ...
    [1.13, 0.1,  5.12, 6.16, 3.58, 4.23, 2.46, 2.28, 2.74, 1.58],
    [1.13, 0.1,  5.53, 6.65, 3.86, 4.35, 2.52, 999, 2.83, 1.62],
    [1.13, 0.1,  6.26, 7.53, 4.38, 4.92, 2.85, 999, 3.20, 1.83],
    [1.13, 0.1,  6.38, 7.68, 4.47, 5.02, 2.90, 999, 3.26, 1.86],
    [1.24, 0.1,  7.21, 8.68, 5.05, 5.67, 3.28, 999, 3.69, 2.10],
    [1.13, 0.1,  7.21, 8.68, 5.05, 5.67, 3.28, 999, 3.69, 2.10]
    ];
    const kuutasu = [ 
    [
