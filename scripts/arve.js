...
function readFile(input) {
  ...
  { var i=0 ;
    ...
    document.getElementById("u_kesk").innerHTML=Math.round(Math.sign(usumma.innerHTML)*Math.abs( usumma.innerHTML )/ ukw.innerHTML *1000)/1000 ;
    document.getElementById("u_kesk_km").innerHTML=Math.round(Math.sign(usumma.innerHTML)*Math.abs(usumma_km.innerHTML) / ukw.innerHTML *1000)/1000 ;
  }
